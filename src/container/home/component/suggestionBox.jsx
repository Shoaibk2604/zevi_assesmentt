...
<img src={outfit5} alt="" width={100} height="100%"/>
    ...
    <h6><a href="/productpage" className="link-title"> Striped shirt dress</a></h6>
    </div>
    <div className='outfit-title'>
    <h6><a href="/productpage" className="link-title"> Satin shirts</a></h6>
    </div>
    <div className='outfit-title'>
    <h6><a href="/productpage" className="link-title"> Denim jumpsuit</a></h6>
    </div>
    <div className='outfit-title'>
    <h6><a href="/productpage" className="link-title"> Leather Dresses</a></h6>
    </div>
    </div>
      </div>
    </div>
